...
// source: D:\git\Lukiya\cms\views\home\index.html
// DO NOT EDIT!
package views
...
func HomeIndex(model *map[string]interface{}, buffer *bytes.Buffer) {
...
<head>
    ...
    <title>`)
	hero.EscapeHTML(boolText(title == "", "TEST TITLE", title+"- TEST TITLE"), buffer)
	buffer.WriteString(`</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" />
    <link rel="stylesheet" href="/css/site.min.css" />
    `)
	buffer.WriteString(dal.GetHtml("head"))
	buffer.WriteString(`
</head>
